                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 text-right">
                                        <div class="huge">Edit Sub-Bab</div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                <?php
                                    $text = "subbab/edit/".$data[0]->id_subbab;
                                    echo form_open($text);
                                ?>
                                <?php
                                ...
                                ?>
                                    <div class="form-group">
                                        <label class="control-label">ID Sub-Bab:</label>
                                        <input class="form-control" name="id_subbab" type="text" value="<?php echo $data[0]->id_subbab?>" readonly></input>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="nama_subbab" value="<?=$data[0]->nama_subbab?>" type="text"></input>
                                    </div>
